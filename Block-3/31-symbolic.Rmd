...
`r insert_calcZ_exercise("XX.XX", "Y7ecmI", "Exercises/frog-pitch-clock.Rmd")`

`r insert_calcZ_exercise("XX.XX", "LPlcgV", "Exercises/lamb-mean-pan.Rmd")`

`r insert_calcZ_exercise("XX.XX", "A0u94a", "Exercises/shark-dive-hamper.Rmd")`

`r insert_calcZ_exercise("XX.XX", "kay2zx", "Exercises/pine-fight-painting.Rmd")`

`r insert_calcZ_exercise("XX.XX", "nef1lB", "Exercises/cat-go-window.Rmd")`

`r insert_calcZ_exercise("XX.XX", "1qDQZz", "Exercises/bird-hold-jacket.Rmd")`

`r insert_calcZ_exercise("XX.XX", "YMuG92", "Exercises/chicken-cost-coat.Rmd")`





`r insert_calcZ_exercise("XX.XX", "LpYZy4", "Exercises/crow-eat-bottle.Rmd")`



<!-- table of integrals --> 
`r insert_calcZ_exercise("31.07", "f6C4Ia", "Exercises/wolf-come-room.Rmd")`
