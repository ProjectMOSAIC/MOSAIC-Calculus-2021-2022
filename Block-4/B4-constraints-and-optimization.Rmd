...
contour_plot(V(x, y) ~ x + y, domain(x=0:10, y=20:30)) %>%
...
Let's take the graphic apart into its constituent components: the objective function and the constraint function. We'll plot both in the same way: a contour plot with the gradient field superimposed.
