...
```{r probe-constant, eval=FALSE, echo=FALSE, fig.cap="A space probe (orange) accelerating in a straight line, but observed as a change in angle $\theta$ seen from a planet (green)."}
Arc1 <- tibble(
