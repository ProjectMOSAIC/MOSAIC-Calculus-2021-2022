...
`r insert_calcZ_exercise("XX.XX", "aoxjLV", "kitten-pay-sheet.Rmd")` <!-- densities all have area 1 -->

`r insert_calcZ_exercise("XX.XX", "nHCIMc", "lamb-hear-roof.Rmd")`

`r insert_calcZ_exercise("XX.XX", "ku4QGW", "horse-cost-spoon.Rmd")`

`r insert_calcZ_exercise("XX.XX", "uKHwI4", "kitten-ring-plant.Rmd")`

`r insert_calcZ_exercise("XX.XX", "HNJn9i", "snake-hurt-candy.Rmd")`

`r insert_calcZ_exercise("XX.XX", "3eLqIt", "Exercises/maple-come-rug.Rmd")`

`r insert_calcZ_exercise("XX.XX", "PEAKVD", "seahorse-catch-cotton.Rmd")`

`r insert_calcZ_exercise("XX.XX", "xa6qsb", "oak-hurt-ring.Rmd")`

`r insert_calcZ_exercise("XX.XX", "1dG7W8", "goat-sit-knob.Rmd")`
...
`r insert_calcZ_exercise("XX.XX", "F7klxV", "seal-tug-mattress.Rmd")` <!-- cumulative probability density and life-expectancy at birth. -->

`r insert_calcZ_exercise("XX.XX", "uZLhZ0", "seaweed-dig-cotton.Rmd")` <!-- life expectancy and standard deviation -->

`r insert_calcZ_exercise("XX.XX", "CeN4GV", "titmouse-read-chair.Rmd")`

`r insert_calcZ_exercise("XX.XX", "ixpCg0", "aspen-bet-roof.Rmd")`
