...
```
# Introduction {- #block4-intro-draft .nonumber}
...
`r {with(xstar, g(x))} |> oneline_block(width="41%", comment="should be zero")`
:::
...
Figure \@ref(fig:argm-ex1) shows the output of `argM()` applied to a randomly generated function.
