...
`r insert_calcZ_exercise("XX.XX -- dot products", "pQLrbc", "Exercises/owl-become-fork.Rmd")`

`r insert_calcZ_exercise("XX.XX -- Vector lengths", "QPShi2", "Exercises/cat-eat-mattress.Rmd")`

`r insert_calcZ_exercise("XX.XX -- Scalar multipliers", "UsntjP", "Exercises/tiger-run-futon.Rmd")`

`r insert_calcZ_exercise("XX.XX -- Orthogonality", "JPtnJM", "Exercises/kangaroo-have-closet.Rmd")`

`r insert_calcZ_exercise("XX.XX -- Angles", "Ihil7U", "Exercises/lamb-throw-candy.Rmd")`
...
`r insert_calcZ_exercise("41.XX -- Collision course?", "MBTGQt", "Exercises/duck-do-pantry.Rmd")`
