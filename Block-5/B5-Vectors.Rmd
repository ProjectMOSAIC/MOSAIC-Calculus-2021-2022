...
`r insert_calcZ_exercise("41.13", "k5u7hG", "Exercises/titmouse-stand-pantry.Rmd")`


<!-- airplane intercept vector -->
`r insert_calcZ_exercise("41.15 -- Collision course?", "MBTGQt", "Exercises/duck-do-pantry.Rmd")`

`r insert_calcZ_exercise("41.23", "Q2ars0", "Exercises/squirrel-hear-glasses.Rmd")`

`r insert_calcZ_exercise("41.25", "N98zli", "Exercises/falcon-begin-door.Rmd")`

`r insert_calcZ_exercise("41.27", "PCfYDo", "Exercises/crocodile-talk-mattress.Rmd")`

`r insert_calcZ_exercise("41.29", "5zmmBu", "Exercises/girl-send-scarf.Rmd")`
