...
"e" as in "eel" | <audio controls><source src = "https://linguistics.ucla.edu/people/hayes/103/Charts/VChart/y.wav" type = "audio/wav"></audio>
      ...
      https://github.com/ProjectMOSAIC/MOSAIC-Calculus/blob/ce9fb2b629e24f67e1b6cf94e764c99a21bf120a/www/i.wav
      
https://linguistics.ucla.edu/people/hayes/103/Charts/VChart/i.wav


Figure \@ref(fig:sam-sound) shows the graph of a real-world function of time. Such functions are omnipresent in our lives, even if we rarely see them as a graph. This one is a short recording of the sound wave that we perceive as the vowel "A" as in Sam.

```{r sam-sound, echo=FALSE, fig.cap="A complicated function of time. The graphical domain is about 1/20th of a second."}
knitr::include_graphics("www/SAM.png")
```
...
Yet, for many tasks it's helpful to have a modeling approach that's well suited to such functions. For example, we might want to identify the speaker from a recording, or to play the recording slower or faster without changing the essence of the sound, or to tweak the function to have additional properties such as being exactly on tune while maintaining its individuality as a sound. 
