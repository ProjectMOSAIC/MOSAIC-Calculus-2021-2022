...
::: {.underconstruction}
Chapter not yet released[...](https://github.com/ProjectMOSAIC/MOSAIC-Calculus/blob/main/Block-5/B5-linear-combinations.Rmd)
:::


[![](www/icons/edit.png)](https://github.com/ProjectMOSAIC/MOSAIC-Calculus/blob/main/Block-5/B5-linear-combinations.Rmd)
...
In the previous chapter, we suggested that you think of a vector as a "step" in a given direction and of a given magnitude as in, "1 foot to the northeast." This interpretation highlights the mathematical structure of vectors: just a direction and a length, nothing else. 
...
As a fanciful example of place, consider a cache of buried treasure. You are given these instructions to get there:
...
knitr::include_graphics("www/compass.jpeg")
```
