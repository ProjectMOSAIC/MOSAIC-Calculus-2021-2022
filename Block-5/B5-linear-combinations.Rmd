...
As a fanciful example of getting to a "place," consider a cache of buried treasure. You are given these instructions to get there:
...
Scalar multiplication is an operation on a single vector. Vector addition and subtraction put together two vectors.
