...
Refer back to the data frame `Car_facts` displayed on a previous page. Describe how `model.matrix()` used the data to create the right-most vector in the model matrix.
