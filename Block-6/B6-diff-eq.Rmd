...
ADD A TAKE-NOTE: Dynamical systems are written as ***autonomous differential equations*** where the dynamical function is takes the state variables as inputs. Contrast this to a ***homogeneous differential equation*** where $\partial_t x = f(t)$, 


<<<<<<< HEAD
Add a pull out about discrete dynamical using Chutes and Ladders as an example and showing how the flow doesn't correspond to a simple continuous state space. 

=======
>>>>>>> 168d359ca3946fda79303a27fe20b93390262136
## The language for change

Calculus is the dominant mathematical mode of describing change. Developed initially in the 1600s as a means of relating planetary motion to the force of gravity felt on Earth, it nonetheless remained the way of describing heat, sound, and  electromagnetism in the 1800s. It the 1900s, calculus was turned to representing the basic mechanisms of quantum mechanics.
...
The calculus language is able to describe a stunning range of systems, for example:
...
What all these systems have in common is that they have an ***state*** that describes the configuration of the system at a given instant in time. "State" in this sense is used in the sense of "the state of affairs," or "his mental state," or "the state of their finances."
