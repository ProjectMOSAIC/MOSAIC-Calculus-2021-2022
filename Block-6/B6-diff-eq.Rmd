...
The state in chutes and ladders is one of the hundred numbers 1, 2, $\ldots$, 100. This is a discrete state space. Therefore, we can describe the "flow" in a very concrete way: how each state is directly connected to another. Figure \@ref(fig:chutes-flow) shows these connections. There is no velocity involved because there is no infinitesimal movement of state. For instance, state 47 connects directly to state 26.
...
`r insert_calcZ_exercise("XX.XX", "OojcwF", "Exercises/bear-blow-kayak.Rmd", skill="G-MC8XJ")`

`r insert_calcZ_exercise("XX.XX", "frkSBa", "Exercises/rat-find-closet.Rmd", skill="D-93XWJ")`

`r insert_calcZ_exercise("XX.XX", "wZsrpW", "Exercises/seaweed-jump-sofa.Rmd", skill="X-MO2V8 X-KZLDP")`

`r insert_calcZ_exercise("XX.XX", "PZjVAc", "Exercises/fish-burn-fridge.Rmd", skill="D-93XWJ")`

`r insert_calcZ_exercise("XX.XX", "9x2tYm", "Exercises/squirrel-tell-chair.Rmd", skill="X-KZLDP")`

`r insert_calcZ_exercise("XX.XX", "34QnFG", "Exercises/cheetah-hit-chair.Rmd", skill="D-93XWJ")`

`r insert_calcZ_exercise("XX.XX", "x4CiKv", "Exercises/ant-keep-screen.Rmd", skill="M-P1ZSV")`

`r insert_calcZ_exercise("XX.XX", "gLXhdu", "Exercises/bird-trim-bulb.Rmd", skill="N-088YI")`

<!-- Greek letters -->
`r insert_calcZ_exercise("XX.XX", "Amzsqx", "Exercises/sheep-chew-dish.Rmd", skill="A-JD4OX")`
