...
$$\require{cancel}\text{Simplification:}\ \ \  \ \ \begin{array}{l}\partial_t x  = \cancel{ax}  +  b y\\\partial_t y =\ c x + \cancel{dy}\end{array}\ .$$
...
$$\begin{array}{c}\partial_{tt} x  =    b\ \partial_{t\ }y\\ \partial_{t\ } y  = \ \ c x   \ \ \end{array}\ .$$
...
$$\begin{array}{c}x(0)  = \ \ A \ \  + \ B\\\partial_t x(0)  =   \lambda_1 A  +  \lambda_2 B\end{array}\ \ \ \ \implies\ \ \ \ 
...
```{r bc-system, echo=FALSE, fig.cap="Three trajectories from the system $$\\begin{array}{c}\\partial_t x = y\\\\\\partial_t y = 2 x\\end{array}$$"}
...
$$\left[\begin{array}{c}1 \ \ \ \ \ \ \ \ \ \ \ \ \  1\\1.4142 \  -1.4142\end{array}\right] \left[\begin{array}{c}A\\ B\end{array}\right] = \left[\begin{array}{c}x(0)\\ \partial_t x(0)\end{array}\right] .$$
