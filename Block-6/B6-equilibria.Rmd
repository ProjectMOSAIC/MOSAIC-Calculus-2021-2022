...
$$\begin{array}{c}\partial_t x(0)  =   \lambda_1 A  +  \lambda_2 B\\x(0)  = \ \ A \ \  + \ B\\\end{array}\ \ \ \ \implies\ \ \ \ 
 \left[\begin{array}{c}\lambda_1 \ \ \ \ \ \lambda_2\\1 \ \ \ \ \ \  1\end{array}\right] \left[\begin{array}{C}A\\ B\end{array}\right] = \left[\begin{array}{C}x(0)\\ \partial_t x(0)\end{array}\right] .$$
...
MAYBE SHOW THAT the vectors and time constants can be calculated using `eigen()`?
