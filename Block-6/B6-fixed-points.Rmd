...
`r insert_calcZ_exercise("XX.XX", "9qOKUM", "spruce-fall-mug.Rmd")`

`r insert_calcZ_exercise("XX.XX", "cAKQiT", "hamster-dive-window.Rmd")`

`r insert_calcZ_exercise("XX.XX", "oKNNim", "lobster-go-lamp.Rmd")`
