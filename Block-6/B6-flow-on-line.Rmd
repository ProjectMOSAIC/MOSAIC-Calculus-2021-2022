...
`r insert_calcZ_exercise("XX.XX", "RdgPMo", "Exercises/maple-bring-plant.Rmd", skill="V-YGS71")`

`r insert_calcZ_exercise("XX.XX", "aCMm4M", "Exercises/squirrel-break-tv.Rmd", skill="J-YOLEG")`

`r insert_calcZ_exercise("XX.XX", "26PFIN", "Exercises/bird-meet-sheet.Rmd", skill="F-QSK86")`
