...
There is actually an area of mathematical theory called ***[catastrophe theory](https://en.wikipedia.org/wiki/Catastrophe_theory)***. We'll use a famous example to show how catastrophes or tipping points are modeled mathematically.

The example comes from a 1977 article in *Nature*, one of the world's most prestigious scientific journals. The article, by Robert May, is entitled "Thresholds and breakpoints in ecosystems with a multiplicity of stable states." The words "thresholds" and "breakpoints" have not been encountered yet in this book, but "multiplicity of stable states" should bring to mind the sort of dynamics seen in Figure \@ref(fig:phase-line-intro2).
...
In his *Nature* article, May modeled the consumption rate by a single cow with the functional form $$C(v) \equiv \frac{\beta v^2}{v_0 - v^2}$$ which is graphed for $\beta=0.1$ and $v_0 = 3$ in Figure \@ref(fig:cow-consumption)
...
Figure \@ref(fig:grazing-comparison2) modifies the pasture dynamics to incorporate this sigmoidal model of consumption.
...
`r insert_calcZ_exercise("XX.XX", "RdgPMo", "Exercises/maple-bring-plant.Rmd", skill="V-YGS71 J-YOLEG")`

`r insert_calcZ_exercise("XX.XX", "aCMm4M", "Exercises/squirrel-break-tv.Rmd", skill="J-YOLEG")`

`r insert_calcZ_exercise("XX.XX", "26PFIN", "Exercises/bird-meet-sheet.Rmd", skill="F-QSK86 V-YGS71")`

`r insert_calcZ_exercise("XX.XX", "pgjnB1", "Exercises/giraffe-feel-blanket.Rmd", skill="X-DE4WK")`

`r insert_calcZ_exercise("XX.XX", "kNlQjd", "Exercises/aspen-ride-knob.Rmd", skill="L-ZPTTA")`

`r insert_calcZ_exercise("XX.XX", "a0w5RG", "Exercises/ape-stand-bowl.Rmd", skill="N-O88YI")`

`r insert_calcZ_exercise("XX.XX", "EBO7nv", "Exercises/lamb-know-saucer.Rmd", skill="L-ZPDIJ")`

`r insert_calcZ_exercise("XX.XX", "fFZUA5", "Exercises/doe-have-piano.Rmd", skill="L-ZDPIJ")`

`r insert_calcZ_exercise("XX.XX", "136TO6", "Exercises/ash-look-sofa.Rmd", skill="J-YOLEG")`
...
`insert_calcZ_exercise("XX.XX", "9aVYdV", "Exercises/dolphin-hang-dish.Rmd")`
--> 
...
`r insert_calcZ_exercise("XX.XX", "qd50WJ", "Exercises/bird-grow-sheet.Rmd")`
