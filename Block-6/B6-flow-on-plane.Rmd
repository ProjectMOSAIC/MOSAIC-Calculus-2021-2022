...
```{r linearized-pendulum, echo=FALSE, fig.cap="Flow field, nullclines, and trajectories of the pendulum (black) and the linearized pendulum (magenta) from three different initial conditions."}
