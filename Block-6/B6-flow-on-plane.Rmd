...
`r insert_calcZ_exercise("XX.XX", "s5x504", "Exercises/bear-give-futon.Rmd")`


`r insert_calcZ_exercise("XX.XX", "ePqij6", "Exercises/finch-show-hamper.Rmd")`

`r insert_calcZ_exercise("XX.XX", "3A3pMv", "Exercises/bee-wake-bottle.Rmd")`

`r insert_calcZ_exercise("XX.XX", "KzgT1c", "Exercises/crow-find-sofa.Rmd")`

<!-- identifying nullclines --> 
`r insert_calcZ_exercise("XX.XX", "owE1WY", "Exercises/eagle-choose-mattress.Rmd")`

<!-- linearization of rabbit-fox system -->
`r insert_calcZ_exercise("XX.XX", "3Ug3IH", "Exercises/cow-sharpen-table.Rmd")`
