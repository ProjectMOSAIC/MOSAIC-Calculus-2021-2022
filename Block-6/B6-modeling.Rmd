...
Mathematician Steven Strogatz proposed in the 1990s that similar equations describe how love between two people varies over time. Strogatz's equations are usually written with state variables R and J, standing for Romeo and Juliet. Positive values represent love, negative values are hate. And best to think of the model as a cartoon, but a cartoon that captures some of the behavior seen in reality.
...
BY CLASSICAL WE MEAN .... Explain what "phase-plane" means, same as "state space" with two variables. 
...
MOVE THIS TO EIGENVALUES CHAPTER.
