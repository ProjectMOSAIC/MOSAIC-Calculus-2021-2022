...
<!-- `insert_calcZ_exercise("XX.XX", "iRZfBY", "Exercises/walnut-tell-pot.Rmd")` n-->

<!-- EXERCISE TO COMPUTE the $a$ parameter in $\dot{x} = a x$ when the information is given in terms of doubling or that population increases 10 fold in an hour.
-->
