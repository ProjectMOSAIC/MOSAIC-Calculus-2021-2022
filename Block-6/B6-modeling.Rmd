...
```{r SIR-half-seventh, echo=FALSE, fig.cap="SIR flow field for $\\beta=1/2, \\alpha = 1/7$, and the trajectory for initial conditions $S_0 = 0.999, I_0 = 0.001$.", message=FALSE}
