...
Unstable linear: unlimited population growth. But since the world is bounded what we're really saying is that we only care what's happening near the fixed point and are ignoring the effects that come into play when the population get's very large.
