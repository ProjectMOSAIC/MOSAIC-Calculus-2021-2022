...
```{r SIR-half-seventh, echo=FALSE, fig.cap="SIR flow field for $\\beta=1/2, \\alpha = 1/7$, and the trajectory for initial conditions $S_0 = 0.999, I_0 = 0.001$."}
...
`r insert_calcZ_exercise("51.XX", "trcQuC", "Exercises/owl-sell-radio.Rmd", skill="X-LG744")`

`r insert_calcZ_exercise("51.XX", "tzVzaH", "Exercises/puppy-take-pantry.Rmd", skill="P-3LIKO")`

`r insert_calcZ_exercise("51.XX", "3mU3qO", "Exercises/hamster-bend-sofa.Rmd", skill="R-208IA")`

<!-- details of dynamical function don't always matter -->
...
`r insert_calcZ_exercise("51.03", "iCYry2", "Exercises/wolf-come-saucer.Rmd")`


`r insert_calcZ_exercise("51.05", "KkxELm", "Exercises/zebra-wake-shoe.Rmd", skill="X-DE4WK N-CB2LE X-LG744 U-5PMG7")`

`r insert_calcZ_exercise("51.07", "I2JVMB", "Exercises/dolphin-go-cotton.Rmd", skill="U-5PMG7 P-3LIKO")`

`r insert_calcZ_exercise("51.09", "uYXvfX", "Exercises/birch-bring-bed.Rmd", skill="L-ZPDIJ dimensions")`

`r insert_calcZ_exercise("51.11", "4jkrKy", "Exercises/rhinosaurus-sharpen-knob.Rmd", skill="L-ZPDIJ dimensions")`
