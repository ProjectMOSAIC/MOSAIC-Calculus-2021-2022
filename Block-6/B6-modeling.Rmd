...
`r insert_calcZ_exercise("XX.XX", "KkxELm", "Exercises/zebra-wake-shoe.Rmd", skill="X-DE4WK N-CB2LE X-LG744 U-5PMG7")`

`r insert_calcZ_exercise("XX.XX", "I2JVMB", "Exercises/dolphin-go-cotton.Rmd", skill="U-5PMG7 P-3LIKO")`

`r insert_calcZ_exercise("XX.XX", "uYXvfX", "Exercises/birch-bring-bed.Rmd", skill="L-ZPDIJ dimensions")`

`r insert_calcZ_exercise("XX.XX", "4jkrKy", "Exercises/rhinosaurus-sharpen-knob.Rmd", skill: "L-ZPDIJ dimensions")`
