...
```{r include=FALSE}
book_file_name <- "block-6/modeling-dynamics.html"
```
...
`r insert_calcZ_exercise("51.XX", "VCWRBs", "Exercises/seal-fly-socks.Rmd")`

`r insert_calcZ_exercise("51.XX", "BbcPyk", "Exercises/finch-look-dish.Rmd")`

`r insert_calcZ_exercise("51.XX", "trcQuC", "Exercises/owl-sell-radio.Rmd")`

<!-- fir-lie-tv --- about retirement savings. NEEDS WORK -->

<!-- `insert_calcZ_exercise("51.XX", "iRZfBY", "Exercises/walnut-tell-pot.Rmd")` n-->
...
`r insert_calcZ_exercise("51.XX", "iCYry2", "Exercises/wolf-come-saucer.Rmd")`
