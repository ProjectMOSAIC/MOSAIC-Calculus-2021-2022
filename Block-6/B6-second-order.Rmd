...
`r insert_calcZ_exercise("54.05", "P4xpYP", "Exercises/pine-bring-window.Rmd", skill="T-ZO94U")`

`r insert_calcZ_exercise("54.07", "Yn47ct", "Exercises/cat-sleep-door.Rmd", skill="W-5ZT92")`

`r insert_calcZ_exercise("54.09", "iX26Ra", "Exercises/falcon-have-mattress.Rmd", skill="D-BRUPM")`

`r insert_calcZ_exercise("54.11", "Pl64dp", "Exercises/deer-cost-door.Rmd", skill="WP-103-14")`

`r insert_calcZ_exercise("54.13", "JsRKvA", "Exercises/chicken-make-room.Rmd", skill="D-BRUPM")`

`r insert_calcZ_exercise("54.17", "CMBvRg", "Exercises/tiger-sharpen-fork.Rmd", skill="F-189B3")`

`r insert_calcZ_exercise("54.19", "N9iexG", "Exercises/chicken-say-lamp.Rmd", skill="F-189B3")`

`r insert_calcZ_exercise("54.23", "6OL44y", "Exercises/sheep-bend-sheet.Rmd", skill="WP-103-14 P-7PXE3")`

`r insert_calcZ_exercise("54.25", "IVEjiX", "Exercises/falcon-shut-hamper.Rmd", skill="F-189B3")`
