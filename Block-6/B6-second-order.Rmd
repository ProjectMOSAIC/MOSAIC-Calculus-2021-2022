...
`r insert_calcZ_exercise("XX.XX", "Pl64dp", "Exercises/deer-cost-door.Rmd")`

`r insert_calcZ_exercise("XX.XX", "JsRKvA", "Exercises/chicken-make-room.Rmd")`

`r insert_calcZ_exercise("XX.XX", "xkQnvD", "Exercises/spider-hide-cotton.Rmd")`
