...
`r insert_calcZ_exercise("XX.XX", "OpK42v", "Exercises/crocodile-dive-laundry.Rmd", skill="O-TEOG4")`


`r insert_calcZ_exercise("XX.XX", "UgVtlJ", "Exercises/cat-bite-futon.Rmd", skill="U-EJM13")`

`r insert_calcZ_exercise("XX.XX", "Z3Mq3G", "Exercises/rabbit-grow-candy.Rmd", skill="N-9IU5J")`

`r insert_calcZ_exercise("XX.XX", "tNLucT", "Exercises/fox-look-magnet.Rmd", skill: "U-5PMG7 V-4KF8Q K-LH9CX N-9IU5J")`
