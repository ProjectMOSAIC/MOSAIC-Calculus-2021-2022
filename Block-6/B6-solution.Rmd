...
## Symbolic solutions {#symbolic-solutions-ODE}
...
`r insert_calcZ_exercise("47.01", "OpK42v", "Exercises/crocodile-dive-laundry.Rmd", skill="O-TEOG4")`


`r insert_calcZ_exercise("47.03", "UgVtlJ", "Exercises/cat-bite-futon.Rmd", skill="U-EJM13")`

`r insert_calcZ_exercise("47.05", "Z3Mq3G", "Exercises/rabbit-grow-candy.Rmd", skill="N-9IU5J")`

`r insert_calcZ_exercise("47.06", "Ku1rfp", "Exercises/maple-beat-plate.Rmd", skill="U-5PMG7")`

`r insert_calcZ_exercise("47.07", "tNLucT", "Exercises/fox-look-magnet.Rmd", skill="U-5PMG7 V-4KF8Q K-LH9CX N-9IU5J")`


<!-- match-lighting model -->
`r insert_calcZ_exercise("47.09", "jd6HE8", "Exercises/ape-grow-oven.Rmd")`

`r insert_calcZ_exercise("47.11", "5DVPWG", "Exercises/spruce-make-lamp.Rmd")`

<!-- dt and quality of numerical solution -->
`r insert_calcZ_exercise("47.13", "Ul19SO", "Exercises/turtle-show-sofa.Rmd")`
