...
You job in this exercise is to set the initial conditions for velocity so that the ball is being fired 250 feet per second at an angle $\theta$ from the horizontal. These initial conditions will be
