...
f <- rfun( ~ u & v, seed=577)
g <- rfun( ~ u & v, seed=186)
f2 <- rfun( ~ u & v, seed=111)
flow_contour(f, g, f2, dom=domain(u=-3:3, v=-3:3)) %>%
...
f <- rfun( ~ u & v, seed=578)
g <- rfun( ~ u & v, seed=187)
f2 <- rfun( ~ u & v, seed=1112)
g2 <- rfun( ~ u & v, seed=2322)
flow_contour(f, g, dom=domain(u=-3:3, v=-4:2)) %>%
