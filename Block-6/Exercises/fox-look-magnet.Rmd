...
3. For initial conditions $x_0 = -5.276, y_0 = -7.152, z_0=19.452$ and $\rho=28$, $\sigma=10$, and $\beta=8/3$, use `integrateODE()` to integrate the equations over $tdur=100$ time units with a stepsize of $dt=0.01$. (This means you should set the `tdur=` argument to `tdur=list(from=0, to=50, dt=0.01)`) Call your trajectory `T1`.
...
T1 <- integrateODE(dx ~ sigma*(y-x), dy ~(x*(rho-z) - y), 
                  ...
                  tdur=list(from=0, to=50, dt=0.01))
