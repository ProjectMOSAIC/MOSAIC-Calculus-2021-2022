...
Exercise: Use the interactive surface plot to find the numerical value of the output of the function when the input is $(x=1, y=2)$ USE an rfun() for this. Just give the interactive plot. 
...
EXERCISE: Contour plot of Heron's formula for fixed $c$. What's going on at the zero contour. Why is nothing shown below the zero contour.
