...
<div style="float:right;">[![](www/icons/edit.png)](https://github.com/ProjectMOSAIC/MOSAIC-Calculus/blob/main/Preliminaries/05-pattern-book-functions.Rmd)</div>

```{r include=FALSE}
book_file_name <- "preliminaries/05-pattern-book-functions.html"
```
