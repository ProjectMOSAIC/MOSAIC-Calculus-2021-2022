...
<div style="float:right;">[![](www/icons/edit.png)](https://github.com/ProjectMOSAIC/MOSAIC-Calculus/blob/main/Preliminaries/05-symbolic.Rmd)</div>

```{r include=FALSE}
book_file_name <- "preliminaries/05-symbolic.html"
```
